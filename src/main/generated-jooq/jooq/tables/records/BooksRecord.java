...
public class BooksRecord extends TableRecordImpl<BooksRecord> implements Record2<Integer, String> {

    private static final long serialVersionUID = 1256320743;
     ...
     */
    public BooksRecord(Integer id, String name) {
        super(Books.BOOKS);
