...
public class TasksRecord extends UpdatableRecordImpl<TasksRecord> implements Record4<Integer, Integer, Integer, String> {

    private static final long serialVersionUID = -1304482385;
     ...
     */
    @Override
    public TasksRecord values(Integer value1, Integer value2, Integer value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TasksRecord(Integer id, Integer projectId, Integer status, String name) {
        super(Tasks.TASKS);
