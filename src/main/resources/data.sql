...
insert into projects values (3,'mercame');

insert into user_to_project values (1, 1);
insert into user_to_project values (1, 3);
insert into user_to_project values (2, 2);

insert into tasks values (1, 1, 1, 1,'seede - frontend');
insert into tasks values (2, 1, 1, 1,'seede - backend');
insert into tasks values (3, 2, 2, 1,'fukaru - frontend');
insert into tasks values (4, 2, 2, 1,'fukaru - backend');
insert into tasks values (5, 3, 1, 1,'mercame - frontend');
insert into tasks values (6, 3, 1, 1,'mercame - backend');
